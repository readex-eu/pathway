...
public class PathwayPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Pathway";
	...
	private PathwayPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PathwayPersistentManager();
		}
