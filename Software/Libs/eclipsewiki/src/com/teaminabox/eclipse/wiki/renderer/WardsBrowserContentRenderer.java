...
import com.teaminabox.eclipse.wiki.text.PAThWayMatcher;
...
public class WardsBrowserContentRenderer extends AbstractContentRenderer {
	...
	private static TextRegionMatcher[]	DEFAULT_RENDERER_MATCHERS	= new TextRegionMatcher[] { new IgnoredTextRegionMatcher(), new UrlMatcher(), new EmbeddedTextRegionMatcher(new EclipseResourceMatcher()), new PAThWayMatcher(), new EclipseResourceMatcher(), new PluginResourceMatcher(), new WikiSpaceMatcher(), new EmbeddedTextRegionMatcher(new JavaTypeMatcher()), new JavaTypeMatcher(), new EmbeddedTextRegionMatcher(new WikiWordMatcher(WardsBrowserContentRenderer.WIKI_WORD_PATTERN)), new WikiWordMatcher(WardsBrowserContentRenderer.WIKI_WORD_PATTERN), new NonLetterOrDigitMatcher(), new LetterOrDigitMatcher() };
	private static TextRegionMatcher[]	DEFAULT_SCANNER_MATCHERS	= new TextRegionMatcher[] { new IgnoredTextRegionMatcher(), new UrlMatcher(), new EmbeddedTextRegionMatcher(new EclipseResourceMatcher()), new PAThWayMatcher(),  new EclipseResourceMatcher(), new PluginResourceMatcher(), new WikiSpaceMatcher(), new EmbeddedTextRegionMatcher(new JavaTypeMatcher()), new JavaTypeMatcher(), new EmbeddedTextRegionMatcher(new WikiWordMatcher(WardsBrowserContentRenderer.WIKI_WORD_PATTERN)), new WikiWordMatcher(WardsBrowserContentRenderer.WIKI_WORD_PATTERN) };
